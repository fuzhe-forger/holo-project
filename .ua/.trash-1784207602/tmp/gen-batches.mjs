...
const dir = "/mnt/d/JAVA/holo-project/.ua/intermediate";
writeFileSync(`${dir}/batch-9.json`, JSON.stringify(batch9, null, 2));
writeFileSync(`${dir}/batch-10.json`, JSON.stringify(batch10, null, 2));
writeFileSync(`${dir}/batch-11.json`, JSON.stringify(batch11, null, 2));

console.log("batch-9.json:", batch9.nodes.length, "nodes,", batch9.edges.length, "edges");
console.log("batch-10.json:", batch10.nodes.length, "nodes,", batch10.edges.length, "edges");
console.log("batch-11.json:", batch11.nodes.length, "nodes,", batch11.edges.length, "edges");
